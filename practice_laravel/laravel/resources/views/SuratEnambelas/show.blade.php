            ...
            <div class="row">
                <div class="col-12">
                    <div class="pt-3 d-flex justify-content-end align-items-center">
                        ...
                        <a href="{{url('suratenambelas/admin/status/'.$SuratEnambelas->id)}}" class="btn btn-success mr-2">Sudah Tercetak</a>
                        @else
                        <a href="{{url('suratenambelas/admin/status/'.$SuratEnambelas->id)}}"" class="btn btn-danger mr-2">Belum Tercetak</a>
                        @endif 
                        <form action="{{ route('SuratEnambelas.destroy',['SuratEnambelas'=>$SuratEnambelas->id]) }}" method="POST">
                            @method('DELETE') @csrf
