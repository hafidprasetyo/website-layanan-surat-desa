    ...
    <body class="bg-light text-dark">
        ...
        <div class="container pt-4 ">
            <div class="row">
                ...
                <h3>Surat Pernyataan Belum Menikah</h3>
                    <hr>
                    <form action="{{ route('SuratEnambelas.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class = "col">
                        ...
                        <div class = "col">
                            ...
                            <div class = "col">
                                ...
                                <input
                                    type="text"
                                    class="form-control @error('nik_ortu') is-invalid @enderror"
                                    id="nik_ortu"
                                    name="nik_ortu"
                        ...
                        <div class="row">
                        <div class = "col">
                                <label for="nama_saksisatu">Nama Saksi I</label>
                                <input
                                    type="text"
                                    class="form-control @error('nama_saksisatu') is-invalid @enderror"
                                    id="nama_saksisatu"
                                    name="nama_saksisatu"
                                    placeholder="Nama Saksi Satu"
                                    value="{{ old('nama_saksisatu') }}">
                                @error('nama_saksisatu')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class = "col">
                                <label for="nik_saksisatu">Nik Saksi I</label>
                                <input
                                    type="text"
                                    class="form-control @error('nik_saksisatu') is-invalid @enderror"
                                    id="nik_saksisatu"
                                    name="nik_saksisatu"
                                    placeholder="Nik Saksi Satu"
                                    value="{{ old('nik_saksisatu') }}">
                                @error('nik_saksisatu')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                        <div class = "col">
                                <label for="nama_saksidua">Nama Saksi II</label>
                                <input
                                    type="text"
                                    class="form-control @error('nama_saksidua') is-invalid @enderror"
                                    id="nama_saksidua"
                                    name="nama_saksidua"
                                    placeholder="Nama Saksi Kedua"
                                    value="{{ old('nama_saksidua') }}">
                                @error('nama_saksidua')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class = "col">
                                <label for="nik_saksidua">Nik Saksi II</label>
                                <input
                                    type="text"
                                    class="form-control @error('nik_saksidua') is-invalid @enderror"
                                    id="nik_saksidua"
                                    name="nik_saksidua"
                                    placeholder="Nik Saksi Kedua"
                                    value="{{ old('nik_saksidua') }}">
                                @error('nik_saksidua')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="pernyataan" rows="3" name="pernyataan" readonly>{{ old('pernyataan') }}menyatakan dengan sesungguhnya bahwa saya belum pernah menikah.</textarea>
                        </div>
                            <div>
