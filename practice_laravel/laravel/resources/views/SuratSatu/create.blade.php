    ...
    <div class="container pt-4 ">
        <div class="row">
            <div class="col-md-8 col-xl-6">
                ...
                <h3>Surat Pendaftaran Peristiwa Kependudukan</h3>
                <hr>
                <form action="{{ route('SuratSatu.store') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col">
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                id="nama" name="nama" placeholder="Nama Lengkap Anda"
                                value="{{ old('nama') }}">
                            @error('nama')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                    ...
                    <label for="persyaratan" class="mt-2"> List Daftar Jenis Permohonan </label>
                    <div class="row">
                        <div class="col">
                            <ul class="list-unstyled">
                                <li>Kartu Keluarga Baru
                                    <ul>
                                        <li>Membentuk Keluarga Baru</li>
                                        <li>Penggantian Kepala Keluarga</li>
                                        <li>Pisah KK</li>
                                        <li>Pindah Datang</li>
                                        <li>WNI dari LN karena pindah</li>
                                        <li>Rentan Admininduk</li>
                                    </ul>
                                </li>
                                <li>Perubahan Data
                                    <ul>
                                        <li>Menumpang Dalam KK</li>
                                        <li>Peristiwa Penting</li>
                                        <li>Perubahan elemen data yang tercantum dalam KK</li>
                                    </ul>
                                </li>
                                <li>Hilang/Rusak
                                    <ul>
                            ...
                            <ul class="list-unstyled">
                                <li>KTP EL
                                    <ul>
                                        <li>Baru</li>
                                        <li>Pindah Datang</li>
                                        <li>Perpanjangan ITAP</li>
                                        <li>Perubahan Status Kewarganegaraan</li>
                                        <li>Luar Domisili</li>
                                        <li>Transmigrasi</li>
                                    </ul>
                                </li>
                    ...
                    <div class="form-group">
                        <label for="permohonan" class="fw-bold">Tulis Jenis Permohonan Apa Saja Yang Akan Diajukan
                            dibawah ini</label>
                        <textarea class="form-control  @error('permohonan') is-invalid @enderror" id="permohonan" rows="3"
                            name="permohonan" placeholder="Contoh KTP EL : Baru Atau Kartu Keluarga Baru : Pisah KK">{{ old('permohonan') }}</textarea>
                    </div>

                    <label for="persyaratan" class="mt-2"> List Daftar Persyaratan Yang Dilampirkan </label>
                    <div class="row">
                        <div class="col">
                            <ul class="list-unstyled">
                                <ul>
                                    <li>KK Lama/KK Rusak</li>
                                    ...
                                    <li>KTP-EL Rusak</li>
                                    <li>Dokument Perjalanan</li>
                                    <li>Surat Keterangan Hilang Dari Kepolisian</li>
                                    <li>Surat Keterangan/Bukti perubahan peristiwa kependudukan dan peristiwa penting
                                    </li>
                                </ul>
                            </ul>
                        </div>
                        <div class="col">
                            <ul class="list-unstyled">
                                <ul>
                                    ...
                                    <li>SPTJM Perkawinan/perceraian belum tercatat</li>
                                    <li>Akta Kematian</li>
                                    <li>Surat pernyataan penyebab terjadinya hilang atau rusak </li>
                                    <li>Surat keterangan pindah dari RI</li>
                                    <li>Surat pernyataan bersedia menerima sebagai anggota keluarga</li>
                                    <li>Surat Pengasuhan anak dari orang tua/wali</li>
                    ...
                    <div class="form-group">
                        <label for="syarat" class="fw-bold">Tulis Persyaratan Apa Saja Yang Dilampirkan dibawah
                            ini</label>
                        <textarea class="form-control @error('syarat') is-invalid @enderror " id="syarat" rows="3" name="syarat"
                            placeholder="Contoh Akta Kematian dan Kartu izin tinggal tetap">{{ old('syarat') }}</textarea>
                    </div>
                    <div>
                    ...
                    <button type="submit" class="btn btn-success mb-2 mt-2">Ajukan</button>
                </form>
            </div>
        </div>
    </div>
