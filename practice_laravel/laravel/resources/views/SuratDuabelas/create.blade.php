        ...
        <div class="container pt-4 ">
            <div class="row">
                ...
                <h3>Surat Keterangan Tidak Mampu</h3>
                    <hr>
                    <form action="{{ route('SuratDuabelas.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class = "col">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="status_ortu" id="status_ortu">
                                <option disabled selected>-- Status Orang Tua --</option>
                                <option
                                    value="MASIH HIDUP"
                                    {{ old('status_ortu')=='MASIH_HIDUP' ? 'selected': '' }}>
                                    MASIH HIDUP
                                </option>
                                <option
                                    value="LUAR DESA/MENINGGAL"
                                    {{ old('status_ortu')=='LUAR_DESA/MENINGGAL' ? 'selected': '' }}>
                                    LUAR DESA/MENINGGAL
                                </option>
                            </select>
                            @error('status_ortu')
                            ...
                            <div class="row">
                            <div class = "col">
                                <label for="nama_ortu">Nama Lengkap Orang Tua</label>
                                <input
                                    type="text"
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="keperluan" rows="3" name="keperluan" placeholder="Keperluan">{{ old('keperluan') }}</textarea>
                        </div>
                            <div>
