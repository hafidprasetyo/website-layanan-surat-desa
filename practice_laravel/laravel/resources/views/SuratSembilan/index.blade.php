    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          ...
          <a class="nav-link text-white active bg-gradient-primary" href="{{ route('SuratSembilan.index') }}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fa fa-file-alt"></i>
            </div>
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Data Surat Keterangan Domisili</li>
          </ol>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Data Surat Keterangan Domisili</h6>
              </div>
            </div>
              ...
              <div class="table-responsive">
                <table class="table align-items-center">
                  <thead>
                    ...
                    <th class="text-center">Provinsi Asal</th>
                    <th class="text-center">Kabupaten Asal</th>
                    <th class="text-center">Kecamatan Asal</th>
                    <th class="text-center">Kelurahan/Desa Asal</th>
                    <th class="text-center">Dusun Asal</th>
                    <th class="text-center">RW Asal</th>
                    <th class="text-center">RT Asal</th>
                    <th class="text-center">Jenis Kelamin</th>
                    <th class="text-center">Pekerjaan</th>
                    <th class="text-center">Agama</th>
                    <th class="text-center">Dusun Domisili</th>
                    <th class="text-center">RW Domisili</th>
                    <th class="text-center">RT Domisili</th>
                ...
                <tbody>
                    @forelse ($surat_sembilans as $surat_sembilans)
                    <tr>
                        <th class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">{{$loop->iteration}}</th>
                        <td class="text-uppercase text-center  font-weight-bolder "><button class="btn {{($surat_sembilans->status == 1) ? 'btn-danger' : 'btn-success' }}" disabled>{{($surat_sembilans->status == 1) ? 'Belum Tercetak' : 'Sudah Tercetak'}}</button></td>
                        <td class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">{{$surat_sembilans->nik}}</td>
                        <td class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                            <a href="{{ route('SuratSembilan.show',['SuratSembilan' => $surat_sembilans->id]) }}">{{$surat_sembilans->nama}}</a>
                        </td>
                        <td class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">{{$surat_sembilans->tempat_lahir}}</td>
                        <td class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">{{$surat_sembilans->tanggal_lahir}}</td>
                        <td class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">{{$surat_sembilans->provinsi_asal}}</td>
                        <td class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">{{$surat_sembilans->kabupaten_asal}}</td>
                        <td class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">{{$surat_sembilans->kecamatan_asal}}</td>
                        <td class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">{{$surat_sembilans->kelurahan_asal}}</td>
                        <td class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">{{$surat_sembilans->dusun_asal}}</td>
                        <td class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">{{$surat_sembilans->rt_asal}}</td>
                        <td class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">{{$surat_sembilans->rw_asal}}</td>
                        <td class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">{{$surat_sembilans->jenis_kelamin}}</td>
                        <td class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">{{$surat_sembilans->pekerjaan}}</td>
                        <td class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">{{$surat_sembilans->agama}}</td>
                        <td class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">{{$surat_sembilans->dusun_domisili}}</td>
                        <td class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">{{$surat_sembilans->rw_domisili}}</td>
                        <td class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">{{$surat_sembilans->rt_domisili}}</td>
                        <td class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">{{$surat_sembilans->keterangan}}</td>
                        <td class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">{{$surat_sembilans->keterangan_lain}}</td>
                        <td class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">{{$surat_sembilans->no_hp}}</td>
                    </tr>
                    @empty
