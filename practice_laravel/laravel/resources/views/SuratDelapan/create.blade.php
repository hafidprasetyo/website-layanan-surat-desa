        ...
        <div class="container pt-4 ">
            <div class="row">
                ...
                <h3>Surat Keterangan Usaha</h3>
                    <hr>
                    <form action="{{ route('SuratDelapan.store') }}" method="POST">
                        @csrf
                        <div class="row">
                        <div class = "col">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="keterangan" rows="3" name="keterangan">{{ old('keterangan') }}berada di jalan...Desa...RT...RW...dan masih berjalan,kondisi lancar serta mempunyai perilaku dan adat istiadat baik</textarea>
                            </div>
                            <div>
