        ...
        <div class="container pt-4 ">
            ...
            @endif
                <h3>Surat Kelahiran</h3>
                    <hr>
                    <form action="{{ route('SuratEmpat.store') }}" method="POST">
                        @csrf
                        <div class="row">
                        <div class = "col">
                        ...
                        <div class="row">
                            ...
                            <div>
                                <label for="nama_bayi">Nama Bayi(Anak)</label>
                                <input
                                    type="text"
                            ...
                            <option disabled selected>-- Tempat Dilahirkan --</option>
                                <option
                                    value="RS/RSB"
                                    {{ old('tempat_dilahirkan')=='RS/RSB' ? 'selected': '' }}>
                                    RS/RSB
                                </option>
                                <option
                                    value="PUSKESMAS"
                                    {{ old('tempat_dilahirkan')=='PUSKESMAS' ? 'selected': '' }}>
                                    PUSKESMAS
                                </option>
                                <option
                                    value="POLINDES"
                                    {{ old('tempat_dilahirkan')=='POLINDES' ? 'selected': '' }}>
                                    POLINDES
                                </option>
                                <option
                                    value="RUMAH"
                                    {{ old('tempat_dilahirkan')=='RUMAH' ? 'selected': '' }}>
                                    RUMAH
                                </option>
                                <option
                                    value="LAINNYA"
                                    {{ old('tempat_dilahirkan')=='LAINNYA' ? 'selected': '' }}>
                                    LAINNYA
                                </option>
                            </select>
                            ...
                            <div>
                                ...
                                <input
                                    type="text"
                                    class="form-control @error('tempat_kelahiran') is-invalid @enderror"
                                    id="tempat_kelahiran"
                        ...
                        <div class="form-group">
                            ...
                            <option disabled selected>-- Jenis Kelahiran --</option>
                                <option
                                    value="TUNGGAL"
                                    {{ old('jenis_kelahiran')=='TUNGGAL' ? 'selected': '' }}>
                                    TUNGGAL
                                </option>
                                <option
                                    value="KEMBAR"
                                    {{ old('jenis_kelahiran')=='KEMBAR' ? 'selected': '' }}>
                                    KEMBAR
                                </option>
                                <option
                                    value="KEMBAR-TIGA"
                                    {{ old('jenis_kelahiran')=='KEMBAR-TIGA' ? 'selected': '' }}>
                                    KEMBAR 3
                                </option>
                                <option
                                    value="KEMBAR-EMPAT"
                                    {{ old('jenis_kelahiran')=='KEMBAR-EMPAT' ? 'selected': '' }}>
                                    KEMBAR 4
                                </option>
                                <option
                                    value="LAINNYA"
                                    {{ old('jenis_kelahiran')=='LAINNYA' ? 'selected': '' }}>
                                    LAINNYA
                                </option>
                            </select>
                            ...
                            <div>
                                ...
                                <input
                                    type="text"
                                    class="form-control @error('kelahiran_ke') is-invalid @enderror"
                                    id="kelahiran_ke"
                                    name="kelahiran_ke"
                            ...
                            <option disabled selected>-- Penolong Kelahiran --</option>
                                <option
                                    value="DOKTER"
                                    {{ old('penolong_kelahiran')=='DOKTER' ? 'selected': '' }}>
                                    DOKTER
                                </option>
                                <option
                                    value="BIDAN/PERAWAT"
                                    {{ old('penolong_kelahiran')=='BIDAN/PERAWAT' ? 'selected': '' }}>
                                    BIDAN/PERAWAT
                                </option>
                                <option
                                    value="DUKUN"
                                    {{ old('penolong_kelahiran')=='DUKUN' ? 'selected': '' }}>
                                    DUKUN
                                </option>
                                <option
                                    value="LAINNYA"
                                    {{ old('penolong_kelahiran')=='LAINNYA' ? 'selected': '' }}>
                                    LAINNYA
                                </option>
                            </select>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    id="berat_bayi"
                                    name="berat_bayi"
                                    placeholder="Berat Bayi Dalam Kg"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    id="panjang_bayi"
                                    name="panjang_bayi"
                                    placeholder="Panjang Bayi Dalam Cm"
