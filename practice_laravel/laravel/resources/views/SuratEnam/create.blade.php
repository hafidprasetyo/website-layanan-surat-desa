        ...
        <div class="container pt-4 ">
            <div class="row">
                ...
                <h3>Surat Keterangan Pengantar</h3>
                    <hr>
                    <form action="{{ route('SuratEnam.store') }}" method="POST">
                        @csrf
                        <div class="row">
                        <div class = "col">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="keterangan" rows="3" name="keterangan" placeholder="Keterangan">{{ old('keterangan') }}</textarea>
                            </div>
                            <div>
