        ...
        <div class="container pt-4 ">
            <div class="row">
                ...
                <h3>Surat Keterangan Kelakuan Baik</h3>
                    <hr>
                    <form action="{{ route('SuratSepuluh.store') }}" method="POST">
                        @csrf
                        <div class="row">
                        <div class = "col">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="keterangan" rows="3" name="keterangan" readonly>Orang tersebut selama di desa/kelurahan kami, berkelakuan baik dan belum pernah tersangkut urusan POLISI / KRIMINALITAS{{ old('keterangan') }}</textarea>
                            </div>
                            <div>
