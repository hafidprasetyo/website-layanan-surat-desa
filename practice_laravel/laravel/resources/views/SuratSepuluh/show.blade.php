            ...
            <div class="row">
                <div class="col-12">
                    <div class="pt-3 d-flex justify-content-end align-items-center">
                        ...
                        <a href="{{url('suratsepuluh/admin/status/'.$SuratSepuluh->id)}}" class="btn btn-success mr-2">Sudah Tercetak</a>
                        @else
                        <a href="{{url('suratsepuluh/admin/status/'.$SuratSepuluh->id)}}"" class="btn btn-danger mr-2">Belum Tercetak</a>
                        @endif 
                        <form action="{{ route('SuratSepuluh.destroy',['SuratSepuluh'=>$SuratSepuluh->id]) }}" method="POST">
                            @method('DELETE') @csrf
