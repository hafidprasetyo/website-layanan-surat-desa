    ...
    <body class="bg-light text-dark">
        ...
        <div class="container pt-4 ">
            <div class="row">
                ...
                <h3>Surat Pernyataan Belum/Tidak Kerja</h3>
                    <hr>
                    <form action="{{ route('SuratTujuhbelas.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class = "col">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="pernyataan" rows="3" name="pernyataan" readonly>{{ old('pernyataan') }}menyatakan dengan sesungguhnya bahwa saya belum/tidak bekerja.</textarea>
                        </div>
                            <div>
