      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Data Admin SPMDG</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Tabel Data Admin</h6>
        </nav>
        <ul class="navbar-nav  justify-content-end">
            @if(Auth()->check())
            <li class="nav-item d-flex pe-5 align-items-center">
              <a class="nav-link text-body font-weight-bold px-0">
                <span class="d-sm-inline d-none">Welcome Back {{Auth()->admins()->username}},</span>
              </a>
            </li>
            @endif
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Data Admin SPMDG || <a href="{{ route ('Admin.create') }}"><button type="submit" class="btn-sm btn-success">Tambah Admin </button></a></h6>
              ...
              <div class="table-responsive">
                ...
                @forelse ($admins as $admins)
                  <tr>
                      ...
                      <td class="text-center text-secondary text-xxs font-weight-bolder opacity-7"><a href="{{ route('Admin.show',['Admin' => $admins->id]) }}">{{$admins->username}}</a></td>
                      <td class="text-center text-secondary text-xxs font-weight-bolder opacity-7">{{$admins->password}}</td>
